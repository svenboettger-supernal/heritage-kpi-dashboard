...
export const ABOUT_SECTIONS = [
  { id: "about-stage-1",   label: "Stage 1" },
  { id: "about-stage-2",   label: "Stage 2" },
  { id: "about-logged",    label: "What gets logged" },
  { id: "about-weighting", label: "Weighting" },
  { id: "about-domains",   label: "Domains" },
];
...
export function renderAbout() {
  return `
    ...
    <section class="about-section">
      ...
      <h3 id="about-stage-1" style="margin-top: 40px;">Stage 1 · Answer accuracy</h3>
      ...
      <h3 id="about-stage-2">Stage 2 · Mapping accuracy</h3>
      ...
      <h3 id="about-logged">What gets logged</h3>
      ...
      <h3 id="about-weighting">Weighting</h3>
      <ul>
      ...
      <h3 id="about-domains">Domains</h3>
      <ul>
